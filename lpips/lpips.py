...
class LPIPS(nn.Module):
    def __init__(self, pretrained=True, net='alex', version='0.1', lpips=True, spatial=False,
                 pnet_rand=False, pnet_tune=False, use_dropout=True, model_path='/PATH/DiT4SR-main/preset/IQAWeights/lpips/vgg16-397923af.pth', eval_mode=True, verbose=True):
        ...
        if (lpips):
            ...
            if (pretrained):
                if (model_path is None):
                    import inspect
                    import os
                    model_path = None # os.path.abspath(
