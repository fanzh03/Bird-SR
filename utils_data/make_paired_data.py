...
parser.add_argument("--save_dir", type=str, default='/PATH/dit4sr_train_data', help='the save path of the training dataset.')
...
parser.add_argument("--crop_size", type=int, default=512, help='crop size for HR images. If 0, use original images without cropping.')
...
print(f'args.gt_path:{args.gt_path}')
#################### REALESRGAN SETTING ###########################
args_training_dataset['queue_size'] = 160
# If crop_size is 0, dataset will skip cropping (modified in realesrgan_dataset.py)
args_training_dataset['crop_size'] = args.crop_size
...
args_training_dataset['use_hflip'] = True # True
...
args_degradation['gt_size']= args.crop_size
...
def realesrgan_degradation(batch,  args_degradation, use_usm=True, sf=4, resize_lq=True):
    ...
    # random crop (skip if crop_size is 0)
