...
class MANIQA(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.vit = timm.create_model('vit_base_patch8_224', pretrained=False, checkpoint_path='/mnt/shared-storage-user/sciprismax/liuyidi/DiT4SR-main/preset/IQAWeights/maniqa/model.safetensors',)
